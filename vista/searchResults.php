...
<body>
    ...
    <div id="main-container">
        <div id="table-cont" >
        <div class="table-cell" style="width:auto;"><div class="card" style="width:18rem;"><img src="../img/user_profile/female.png" class="card-img-top"><div class="card-body"><h5 class="card-tittle">8350175</h5><p class="card-text">Ariana Flores Gastelum</p></div></div></div>
        </div>
    </div>
    <footer>
